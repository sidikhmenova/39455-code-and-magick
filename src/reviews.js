...
(function() {
  var getReviewElement = require('./reviews_template');
  var filter = require('./reviews_filter');
  var getPageReview = require('./reviews_paigination');
  ...
  function renderReview(data, page, replace) {
    var pageReview = getPageReview(data, page, replace);
